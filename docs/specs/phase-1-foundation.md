...
| P1-AC05 | Bounded malformed/large/slow/overload/deadline requests, sanitized errors and permit reuse | HiringApiRoutesSpec, RequestContextSpec | PASS: request-size, media, quality precedence, 500/field errors, and barrier-proven recovery of all 16 permits |
