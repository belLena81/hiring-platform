...
- Use business-meaningful names for production classes, modules, functions, fixtures, and tests. Do not name code after phases, scaffolding, implementation process, or temporary development milestones when the code now represents a hiring-platform capability.
