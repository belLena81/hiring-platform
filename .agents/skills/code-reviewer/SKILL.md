...
- Flag production names that describe phases, scaffolding, delivery process, or temporary implementation history instead of business concepts. Require domain-meaningful alternatives before PASS when unclear names affect maintainability or API understanding.
