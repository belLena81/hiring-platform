...
- Preserve PostgreSQL/Doobie conventions in the existing scaffold. SQL schema changes require versioned Flyway migrations; tooling adoption is explicit because Flyway is not currently enabled. MongoDB changes require versioned, repeatable migration/index steps with recovery and verification.
