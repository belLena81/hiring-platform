...
private[graphql] object HiringGraphQLSchemaAssembly {
  ...
  lazy val mutationType: ObjectType[RequestContext, Unit] = ObjectType("Mutation", fields[RequestContext, Unit](
    ...
    ioField("publishJob", publishJobResultType, jobActionInputArgument :: Nil)(context => changeJob(context, "publishJob", _.publishJob)),
    ioField("closeJob", closeJobResultType, jobActionInputArgument :: Nil)(context => changeJob(context, "closeJob", _.closeJob)),
    ioField("acceptApplication", acceptApplicationResultType, applicationActionInputArgument :: Nil)(context => applicationStatusAction(context, "acceptApplication", ApplicationStatus.Accepted)),
    ioField("moveApplicationToInterview", interviewApplicationResultType, applicationActionInputArgument :: Nil)(context => applicationStatusAction(context, "moveApplicationToInterview", ApplicationStatus.Interview)),
    ioField("hireApplication", hireApplicationResultType, applicationActionInputArgument :: Nil)(context => applicationStatusAction(context, "hireApplication", ApplicationStatus.Hired)),
